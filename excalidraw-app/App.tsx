...
const ExcalidrawWrapper = () => {
  ...
  const showLegacyUI = !isChatCanvasMode;
  ...
  const excalidrawContent = (
    <Excalidraw
      ...
      renderTopRightUI={(isMobile) => {
        if (isChatCanvasMode || isMobile || !collabAPI || isCollabDisabled) {
          return null;
        }
    ...
    >
        ...
        {showLegacyUI && <AppFooter onChange={() => excalidrawAPI?.refresh()} />}
